...
const projects = [
    "Cthnn Portfolio",
    "NVIDIA Jetson Self-Driving Car",
    "Flight Simulator",
    "Colts Redistrictor",
]
const desc = [
...
export const ProjectsBox = ({ ...props }) =>{
    ...
    return(
        <>
            <div style={{zIndex:1}} className="w-[90%] h-[72%] border-2 border-[#d4af37] rounded-xl mt-[1%] flex justify-center flex-col items-center z-1 md:w-3/4 md:h-1/10">
                <div className="user-select-none w-[99%] h-[99%] bg-[#5c5c5cb3] rounded-xl flex justify-evenly flex-row-reverse items-center z-1 md:justify-center">
                    ...
                    <div className="user-select-none w-[min(50cqw,105cqh)] h-[99%] flex justify-center items-center flex-col z-1 md:flex-row-reverse">
                        <img onPointerDown={goToProjectPage} style={{ zIndex: 1, userSelect:"none" }} className="w-[40%] z-1" src={images[cardNum]}/>
                        <div className="w-full flex flex-col justify-center items-center md:w-[48%] md:h-[90%]">
                            <h1 onPointerDown={goToProjectPage} style={{userSelect: "none"}} className="w-full text-center text-[min(3cqw,3cqh)] font-pixelify text-[#d4af37] underline underline-offset-[1%] underline-thickness-[1%] md:text-[min(3cqw,3cqh)]">{projects[cardNum]}</h1>
                            <p style={{userSelect: "none"}} className="w-full text-center font-pixelify text-[#d4af37] text-[min(1cqw,1cqh)] md:text-[min(1.5cqw,1.5cqh)]">{desc[cardNum]}</p>
                        </div>
                    </div>
